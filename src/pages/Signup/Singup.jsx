...
import { AuthContainer, Section } from "./SingupStyled";
...
export function Signup() {
    ...
    return ( <AuthContainer>
        <Section type = "signin">
        <h2> Entrar </h2> <form onSubmit = { handleSubmitSignin(inHanleSubmit) } >
        ...
        <Input type="text" placeholder="Nome" name="name" register = { registerSignup } /> {
            ...
            errorsSignup.password && ( <ErrorSpan> { errorsSignin.password.message } </ErrorSpan>
            )
